...
**Bitcoin Cash (`BCH`)** is a decentralized Peer-to-Peer (P2P) electronic cash system. Bitcoin Cash brings sound money to the world, fulfilling the original promise of the whitepaper: ["Bitcoin: A Peer-to-Peer Electronic Cash System"](https://bitcoincash.org/bitcoin.pdf).

Transactions are conducted on-chain with average transfer fees **below** $0.01, and settlements are near-instant since we embrace zero-confirmation ("zero-conf") when possible.
